...
pluralCaseList.push( {plural: "flights/flights", pascal: "FlightFlight"} )

pluralCaseList.push( {plural: "flightreservations/flightReservations", pascal: "FlightreservationFlightReservation"} )

pluralCaseList.push( {plural: "payments/payments", pascal: "PaymentPayment"} )

pluralCaseList.push( {plural: "lodgings/lodgings", pascal: "LodgingLodging"} )

pluralCaseList.push( {plural: "lodgingreservations/lodgingReservations", pascal: "LodgingreservationLodgingReservation"} )
