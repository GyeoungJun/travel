        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="flightReservations"
                        to="/flightreservations/flightReservations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="lodgingReservations"
                        to="/lodgingreservations/lodgingReservations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'flightReservations', 
                route: '/flightreservations/flightReservations',
                ImageUrl: '',
            },
            { 
                title: 'Payment', 
            ...
            { 
                ...
                description: '', 
                key: 'lodgingReservations', 
                route: '/lodgingreservations/lodgingReservations',
                ImageUrl: '',
            },
