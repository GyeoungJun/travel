                ...
                <v-list-item v-for="(data, n) in values" :key="n">
                    ...
                    <v-list-item-content>
                        ...
                        <v-list-item-subtitle style="font-size:25px; font-weight:700;">
                            ...
                            [ FlightReservationId :  {{data.flightReservationId }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ UserId :  {{data.userId }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            [ Status :  {{data.status }} ] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <PaymentPayment :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
